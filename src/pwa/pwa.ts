...
export const PWA_DISMISSED_AT_KEY = 'dev-stage-pwa-dismissed-at';
export const PWA_INSTALLED_HINT_AT_KEY = 'dev-stage-pwa-installed-hint-at';
...
export function removeTimestamp(storage: Storage | undefined, key: string): void {
  try {
    ...
    // Storage is optional; runtime PWA state must continue without it.
  }
}
