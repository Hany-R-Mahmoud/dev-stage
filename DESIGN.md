...
- **Sizing**: the frame owns layout sizing; carousel images use `object-fill` to fill the 16:10 card completely, while directory and detail images use `object-contain` to preserve complete screenshots.
